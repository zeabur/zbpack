...
// TransformStatic transforms the build output of static to serverless format.
func TransformStatic(imageRootDirectory string, dotZeaburDirectory string) error {
